...
namespace ExaminationSystem.Persistence.DB.Migrations
{
    ...
    [Migration("20260420195339_AddPasswordResetToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.User.ApplicationUser.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.PasswordResetTemporaryToken.PasswordResetTemporaryToken", b =>
                {
                    b.HasOne("ExaminationSystem.Domain.Entities.User.ApplicationUser.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ExaminationSystem.Domain.Entities.User.ApplicationUser.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
